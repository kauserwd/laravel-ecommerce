    ...
    <ul class="nav">
        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{url('/show_products')}}">All Products</a>
                    </li>
        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="admin/pages/samples/blank-page.html"> Blank
                            Page </a></li>
                    ...
                    <li class="nav-item"> <a class="nav-link" href="admin/pages/samples/login.html"> Login </a>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="admin/pages/samples/register.html"> Register
                        </a></li>
                </ul>
            </div>
        </li>
